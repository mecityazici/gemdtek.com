...
@section('title', 'Haberler — GEMDTEK')
...
<section class="bg-navy-900 text-cream">
    <div class="container-tight py-20 md:py-28">
        <p class="font-mono text-xs uppercase tracking-widest text-brass-300 mb-4">Haberler</p>
        <h1 class="text-4xl md:text-5xl font-display font-bold mb-6 max-w-3xl leading-tight">
            Duyurular, blog ve <span class="text-brass-400">basında biz.</span>
        </h1>
        <p class="text-lg text-cream/80 max-w-3xl">
            Kulüpten son haberler, teknik blog yazıları ve basında yer alan kapsamımız.
        </p>
    </div>
</section>
...
<section class="container-tight pb-20">
    @if ($posts->isEmpty())
        <div class="max-w-2xl mx-auto text-center bg-cream rounded-xl p-12 border border-graphite/10">
            <p class="font-display text-xl text-navy-800 font-bold">Bu kategoride haber yok.</p>
        </div>
    @else
